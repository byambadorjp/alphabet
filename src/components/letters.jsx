...
export const Letters = () => {
    return (
        <div className='flex justify-evenly flex-wrap'>
            ...
            <LetterCard letter="fairytail" imageUrl="https://lh3.googleusercontent.com/proxy/GIwDT1GtQRXPvn6KQHbCSC4gRfwWWg56iL0cPAMxP1ooQdWFYDxCa869IBoTO8drTTE07dYc8n8jGnl2zNqZ4kwo-rT9jpJrB-K5Gt4Rv7FIUgxImYY"/>
        </div>
    )
}