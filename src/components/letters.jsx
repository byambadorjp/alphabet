...
export const Letters = () => {
    return (
        <div className='flex justify-evenly wrap'>
            ...
            <LetterCard letter="R" imageUrl="https://w7.pngwing.com/pngs/686/86/png-transparent-rabbit-cartoon-cuteness-cartoon-cute-little-rabbit-cartoon-character-white-mammal.png" />
