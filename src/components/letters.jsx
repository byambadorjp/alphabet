...
export const Letters = () => {
    return (
        <div className='flex justify-evenly'>
            ...
            <LetterCard letter="W" imageUrl="https://toppng.com/uploads/preview/watermelon-png-transparent-free-images-watermelon-and-strawberries-together-11563095756hehdmryn88.png" />
        </div>
    )
}